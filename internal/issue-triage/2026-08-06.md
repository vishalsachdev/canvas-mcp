...
- **#170** (zqian — student write tools, FERPA-adjacent) — zqian's last word was 2026-07-29: "will update you soon" on the two design questions you asked (default posture for `COURSE_AGENT_POLICY_DEFAULT`; comfort with the syllabus as the policy carrier). 8 days with no follow-up.
